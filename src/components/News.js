...
export class News extends Component {
  ...
  async update() {
    let url = `https://newsapi.org/v2/top-headlines?country=us&category=${this.props.category}&apiKey=7b059855142940549b04611f0728f5d6&page=${this.state.page}&pageSize=10`;
